...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--conserve_memory_ratings", action="store_true", default=False, help="Whether to conserve memory for ratings")
    parser.add_argument("--conserve_memory", action="store_true", default=False, help="Whether to conserve memory during generation")
...
def main() -> None:
    ...
    results = generate_survival_results_generic(
        ...
        generator_params=config.generator_params(
            ...
            conserve_memory_ratings=args.conserve_memory_ratings,
        ),
